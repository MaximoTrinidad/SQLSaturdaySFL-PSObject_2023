<#	
	...
	===========================================================================
	.DESCRIPTION
		Sample-SQLMethod1_SqlClientb - Windows Authentication.
#>

## - 
## - Windows Authentication Sample:
## - 
Write-Host "Windows Authentication Sample`r`n" -ForegroundColor Yellow;
...
Write-Host "Initializing SQL/db Instance:`r`n" -ForegroundColor Yellow;
Read-Host "Press Enter to continue";

## - Build the T-SQL script to use for build the SQLData object:
## - 
$TSQLQuery = @"
SELECT  [ProductKey]
      ,[DateKey]
...
$SqlconnString = "Server=$SQLServerName; Database=$DatabaseName; timeout=65535; Trusted_Connection=True; Integrated Security=True";
